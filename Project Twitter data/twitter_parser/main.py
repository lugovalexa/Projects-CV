...
if __name__ == "__main__":
    ...
    dates_list = pd.read_csv("/Users/alexandralugova/Documents/GitHub/GEM/code/twitter/twitter_parser/capture_jobs.csv", sep=";")  # IMPORT THE JOBS LIST
    ...
    for index, row in dates_list.iterrows():
        ...
        filename = (f"{capture_time}__from_{start_date}__to__{end_date}").replace(":", "-")
